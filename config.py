...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7754653939:AAFVaBD-Yfwu2Gxst6q38Cfw1aPbGO9JMvE")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002099692683"))
...
try:
    ADMINS=[5192808332]
    for x in (os.environ.get("ADMINS", "5192808332").split()):
        ADMINS.append(int(x))
except ValueError:
